...
<html lang="en">
  ...
  background-image: linear-gradient(to right, white 10%, #355764 90%);
...
<nav class="navbar navbar-expand-lg">
    ...
    <div id="main">
      ...
      <!-- checkout validations js file -->

      <script src="<?php echo $baseurl;?>js/valid.js" type="text/javascript"></script>
   </body>
</html>