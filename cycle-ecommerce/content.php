         ...
         <div class="row">
            <div class="col-md-6">
               <div class="box_main">
                  ...
                  <div class="image_2"><img src="<?php echo $baseurl;?>images/img-2.png"></div>
               </div>
            </div>
            <div class="col-md-6">
...
<div class="about_section layout_padding">
   <div class="container">
      ...
      <div class="about_main">
         <img src="<?php echo $baseurl;?>images/img-5.png" class="image_5">
      </div>
               ...
               <div class="client_main">
                  ...
                  <div class="client_section_2">
                     <div class="client_left">
                        <div><img src="<?php echo $baseurl;?>images/client-img.png" class="client_img"></div>
                     </div>
                     <div class="client_right">
                        <div class="quote_icon"><img src="<?php echo $baseurl;?>images/quote-icon.png"></div>
         ...
         <div class="row">
            <div class="col-sm-4">
               <div class="box_main_1">
                  <div class="zoomout frame"><img src="<?php echo $baseurl;?>images/img-6.png"></div>
            ...
            <div class="col-sm-4">
               <div class="box_main_1">
                  <div class="zoomout frame"><img src="<?php echo $baseurl;?>images/img-7.png"></div>
                  <div class="padding_15">
                     <h2 class="speed_text">Speed cycle</h2>
                     <div class="post_text">Post by : Den <span style="float: right;">20-12-2019</span></div>
                     <p class="long_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using </p>
            ...
            <div class="col-sm-4">
               <div class="box_main_1">
                  <div class="zoomout frame"><img src="<?php echo $baseurl;?>images/img-8.png"></div>
                  <div class="padding_15">
